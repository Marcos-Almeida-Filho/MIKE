 ...
 * @author Marcos Filho
 */
public class DocumentosRastreamentoDocumentos extends javax.swing.JInternalFrame {

    /**
     * Creates new form Documentos
     */
    public DocumentosRastreamentoDocumentos() {
        initComponents();
    }
    ...
    private void chooserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooserActionPerformed
        if (txtdescarquivo.getText().equals("")) {
            ...
            if (evt.getActionCommand().equals("ApproveSelection")) {
                DefaultTableModel model = (DefaultTableModel) RastreamentoDocumentos.tabledocumentos.getModel();
