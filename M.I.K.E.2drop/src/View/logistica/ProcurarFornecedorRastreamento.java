 ...
 * @author Marcos Filho
 */
public class ProcurarFornecedorRastreamento extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProcurarCliente
     */
    public ProcurarFornecedorRastreamento() {
        initComponents();
        filltableclientes();
    }
    ...
    public static void filltableclientes() {
        ...
        model.setNumRows(0);
        FornecedoresDAO cd = new FornecedoresDAO();

        for (FornecedoresBean cb : cd.read()) {
    ...
    private void txtpesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpesquisaKeyReleased
        ...
        for (FornecedoresBean cb : cd.pesquisa(txtpesquisa.getText())) {
            model.addRow(new Object[]{
                cb.getId(),
                cb.getNome(),
                cb.getRazaosocial()
