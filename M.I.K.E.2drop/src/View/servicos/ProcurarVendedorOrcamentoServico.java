 ...
 * @author Marcos Filho
 */
public class ProcurarVendedorOrcamentoServico extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProcurarCliente
     */
    public ProcurarVendedorOrcamentoServico() {
        initComponents();
        readtablevendedores();
    }
    ...
    private void txtpesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpesquisaKeyReleased
        if (txtpesquisa.getText().equals("")) {
            ...
            for (UsuariosBean ub : ud.pesquisa(txtpesquisa.getText())) {
                model.addRow(new Object[]{
                    ub.getId(),
                    ub.getNome()
                });
