 ...
 * @author Marcos Filho
 */
public class ProcurarCondicaoDePagamentoOrcamentoServico extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProcurarCondicaoDePagamento
     */
    public ProcurarCondicaoDePagamentoOrcamentoServico() {
        initComponents();
        filltablecondicoes();
    }
    ...
    private void txtpesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpesquisaKeyReleased
        ...
        for (CondicaoDePagamentoBean cpb : cpd.pesquisa(txtpesquisa.getText())) {
            model.addRow(new Object[]{
                cpb.getId(),
                cpb.getNome()
            });
