...
import static View.servicos.OS.lbldirectory;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (tabledocumentos.getRowCount() == 0) {
            ...
            if (resp == 0) {
                ...
                for (int i = 0; i < nr; i++) {
                    if (tabledocumentos.getValueAt(i, 0).equals(true)) {
                        File file = new File((String) tabledocumentos.getValueAt(i, 4));
                        try {
                        ...
                        ServicoMateriaisDocumentosBean spdb = new ServicoMateriaisDocumentosBean();
                        ServicoMateriaisDocumentosDAO spdd = new ServicoMateriaisDocumentosDAO();
