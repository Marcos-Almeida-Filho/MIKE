...
import DAO.CAPDAO;
import View.comercial.ProcurarFornecedor;
 ...
 * @author Marcos Filho
 */
public class AdicionarContasPagar extends javax.swing.JInternalFrame {

    /**
     * Creates new form AdicionarContasPagar
     */
    public AdicionarContasPagar() {
        initComponents();
        data();
        readcbbancos();
        travacampos();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Adicionar Contas A Pagar");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtdatalancamento, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtid.getText().equals("")) {
            ...
            capb.setNotafiscal(txtnf.getText());
...
//            datalancamento = ?, fornecedor = ?, notafiscal = ?, dataemissao = ?, total = ?, parcela = ?, valorparcela = ?, dataparcela = ?, datapagamento = ?, banco = ?, metodo = ?, status = ? WHERE id = ?
    ...
    private void btnprocurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprocurarActionPerformed
        ProcurarFornecedor pf = new ProcurarFornecedor();
