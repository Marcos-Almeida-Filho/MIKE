 ...
 * @author Marcos Filho
 */
public class ProcurarVendedorClientes extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProcurarCliente
     */
    public ProcurarVendedorClientes() {
        initComponents();
        readtablevendedores();
    }
    ...
    private void tablevendedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablevendedoresMouseClicked
        if (evt.getClickCount() == 2) {
            Clientes.txtvendedor.setText(tablevendedores.getValueAt(tablevendedores.getSelectedRow(), 1).toString());
            dispose();
        }
