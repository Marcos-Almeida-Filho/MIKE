...
public class CAPDocumentosDAO {
    ...
    public void create(CAPDocumentosBean spdb) {
        ...
        try {
            ...
            stmt.setString(1, spdb.getIdcap());
    ...
    public List<CAPDocumentosBean> readitens(String idorcamento) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                iosb.setIdcap(rs.getString("idcap"));
    ...
    public void update(CAPDocumentosBean spdb) {
        ...
        try {
            ...
            stmt.setString(3, spdb.getIdcap());
