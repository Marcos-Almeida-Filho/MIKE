...
public class VendasMateriaisMovDAO {
     ...
     * <p>
     * Stmt = INSERT INTO vendas_materiais_mov (idmaterial, qtdinicial, qtdmovimentada, saldo, tipo, data, usuario) 
     * 
     ...
     * @param tipo String contendo o tipo de movimentação. (Ex: "Encerramento de OS", "Emissão de Nota Fiscal", etc.)
     * @param data Date com a data da movimentação
     * @param user String com o nome do usuário que fez a movimentação
     * 
     * @since 2.0.0
     */
    public void create(int idmaterial, double qtdinicial, double qtdmovimentada, double saldo, String tipo, String data, String user) {
        conStmt();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao criar movimentação do material.\n" + e);
    ...
    public List<VendasMateriaisMovBean> read(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Erro ao ler movimentação do material.\n" + e);
            SendEmail.EnviarErro2(e.toString());
        } finally {
