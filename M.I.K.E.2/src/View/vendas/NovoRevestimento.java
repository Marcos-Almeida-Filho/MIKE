 ...
 * @author Marcos Filho
 */
public class NovoRevestimento extends javax.swing.JInternalFrame {

    RevestimentoDAO rd = new RevestimentoDAO();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtNome.getText().equals("")) {
            ...
            if (idRev == 0) {
                rd.create(nome, codigo);
            } else {
                rd.update(nome, codigo, idRev);
            }

            CadastroDeRevestimento.lerRevestimentos();
            VM1.lerRevestimento();
            dispose();
        }
