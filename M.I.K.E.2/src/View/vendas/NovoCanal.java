 ...
 * @author Marcos Filho
 */
public class NovoCanal extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtNome.getText().equals("")) {
            ...
            if (idCanal == 0) {
                try {
                    cd.create(nome, codigo, descricao);
                ...
                cd.update(nome, codigo, descricao, idCanal);
            }

            CadastroDeCanal.lerCanais();
            VM1.lerCanais();
            dispose();
        }
