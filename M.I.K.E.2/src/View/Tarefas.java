...
public class Tarefas extends javax.swing.JFrame {
    ...
    public void tabletarefas() {
        ...
        model.addRow(new Object[]{
            "OS's abertas",
            "Existem " + od.osaberta() + " OS's abertas. Favor encerrar!"
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seja Bem Vindo(a)! Suas tarefas incluem:");
        ...
        if (tabletarefas.getColumnModel().getColumnCount() > 0) {
            tabletarefas.getColumnModel().getColumn(0).setMinWidth(120);
            tabletarefas.getColumnModel().getColumn(0).setPreferredWidth(120);
            tabletarefas.getColumnModel().getColumn(0).setMaxWidth(120);
        }
