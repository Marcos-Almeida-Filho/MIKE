...
//            txtsite.setText(sb.getSite());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (numtrue == 0) {
            ...
            if (resp == 0) {
                for (int i = 0; i < rc; i++) {
                    if (tableacesso.getValueAt(i, 1).equals(true)) {
                        sab.setId(Integer.parseInt(tableacesso.getValueAt(i, 0).toString()));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        int resp = JOptionPane.showConfirmDialog(null, "Deseja incluir um novo cadastro?", "Novo", JOptionPane.YES_NO_OPTION);
        if (resp == 0) {
            zeracampos();
            txtnome.requestFocus();
            criador();
