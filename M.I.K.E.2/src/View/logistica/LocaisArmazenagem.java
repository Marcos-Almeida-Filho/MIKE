 ...
 * @author Marcos Filho
 */
public class LocaisArmazenagem extends javax.swing.JInternalFrame {

    /**
     * Creates new form LocaisArmazenagem
     */
    public LocaisArmazenagem() {
        initComponents();
        readLocal();
    }
        ...
        if (txtPesquisa.getText().equals("")) {
            switch (cbStatus.getSelectedIndex()) {
                case 2:
                    ...
                    break;
                default:
                    ld.readStatus(cbStatus.getSelectedItem().toString()).forEach(lb -> {
                        model.addRow(new Object[]{
                            lb.getId(),
                            false,
                            lb.getNome(),
            ...
            switch (cbStatus.getSelectedIndex()) {
                case 2:
                    ld.readPesquisa(txtPesquisa.getText()).forEach(lb -> {
                        model.addRow(new Object[]{
                            lb.getId(),
                            false,
                            lb.getNome(),
                    ...
                    break;
                default:
                    ld.readStatusPesquisa(cbStatus.getSelectedItem().toString(), txtPesquisa.getText()).forEach(lb -> {
                        model.addRow(new Object[]{
                            lb.getId(),
                            false,
                            lb.getNome(),
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Locais de Armazenagem");
        ...
        if (tableLocal.getColumnModel().getColumnCount() > 0) {
            ...
            tableLocal.getColumnModel().getColumn(1).setMinWidth(35);
            tableLocal.getColumnModel().getColumn(1).setPreferredWidth(35);
            tableLocal.getColumnModel().getColumn(1).setMaxWidth(35);
        }
        ...
        jButton2.setText("Adicionar Armário");
        ...
        jButton3.setText("Desativar Local");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i = 0; i < tableLocal.getRowCount(); i++) {
            if (tableLocal.getValueAt(i, 1).equals(true)) {
                numtrue++;
            }
        }
        ...
        if (numtrue == 0) {
            ...
            int resp = JOptionPane.showConfirmDialog(null, "Deseja realmente desativar este(s) local(is)?", "Desativar Local", JOptionPane.YES_NO_OPTION);
            if (resp == 0) {
                for (int i = 0; i < tableLocal.getRowCount(); i++) {
                    if (tableLocal.getValueAt(i, 1).equals(true)) {
                        ld.desativar(Integer.parseInt(tableLocal.getValueAt(i, 0).toString()));
                    }
                }
            }
            readLocal();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ArmarioLocaisArmazenagem ala = new ArmarioLocaisArmazenagem();
        Telas.AparecerTela(ala);
