 ...
 * @author Marcos Filho
 */
public class DocumentosCAR extends javax.swing.JInternalFrame {

    /**
     * Creates new form Documentos
     */
    public DocumentosCAR() {
        initComponents();
    }
    ...
    private void chooserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooserActionPerformed
        if (txtdescarquivo.getText().equals("")) {
            ...
            if (evt.getActionCommand().equals("ApproveSelection")) {
                DefaultTableModel model = (DefaultTableModel) AdicionarContasAReceber.tabledocumentos.getModel();
